<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">SPP <BR>AROSS A.R</div>
    </a>
    <!-- Divider -->
    ...
    <li class="nav-item active">
        <a class="nav-link" href="/petugas">
            <i class="fas fa-fw-solid fa-user-lock"></i>
            <span>Petugas</span></a>
    </li>
    <!-- Divider -->
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
            <i class="fas fa-fw fa-solid fa-messages-dollar"></i>
            <span>Transaksi</span>
        </a>
    ...
    <li class="nav-item">
        <a class="nav-link" href="/laporan">
            <i class="fas fa-fw fa-regular fa-wallet"></i>
            <span>Jenis Bayar</span></a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="/laporan">
            <i class="fas fa-fw fa-solid fa-envelope-open-text"></i>
            <span>Laporan</span></a>
    </li>
    <!-- Divider -->

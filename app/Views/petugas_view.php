    ...
    <div class="col">
        <div class="card border">
            <div class="card-header bg-primary">
                <a href="#" data-petugas="" class="btn btn-outline-light" data-target="#modalPetugas"
                    data-toggle="modal"><i class="fas fa-fw fa-solid fa-user-plus"></i> Tambah Data</a>
            </div>
            <div class="card-body">
...
foreach ($Petugas as $row) {
    $data = $row['nama_petugas'] . "," . $row['username'] . "," . $row['no_hp'] . "," . $row['jabatan'] . "," . $row['hak_akses'] . "," . base_url('petugas/edit/' . $row['id_petugas']);
    # code...
    $no++;
?>
                    <tr>
                        ...
                        <td>
                            <a href="" data-petugas="<?= $data?>" data-target="#modalPetugas" data-toggle="modal"
...
?>
            ...
            <div class="modal fade" id="modalPetugas" tabindex="-1" aria-labelledby="modalPetugasLabel"
                aria-hidden="true">
                        ...
                        <form id="form" action="" method="post">
                            <div class="card-body">
                                ...
                                <div class="from-group">
                                    ...
                                    <input type="checkbox" name="ubahpassword" aria-label="Mau Ubah Password"
                                        class="form-control" id="ubahpassword">
                                </div>
                            </div>
            ...
            $(document).ready(function () {
                $("#modalPetugas").on('show.bs.modal', function (event) {
                    ...
                    if (data != "") {
                        ...
                        $('#no_hp').val(barisdata[2]);
                        $('#jabatan').val(barisdata[3]).change();
                        $('#hak_akses').val(barisdata[4]).change();
                        $('#form').attr('action', barisdata[5]);
                    } else {
                        $('#nama_petugas').val('');
                        $('#username').val('');
                        $('#no_hp').val('');
